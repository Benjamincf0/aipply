...
export const agentFillInfoPrompt = `You are an intelligent AI assistant helping to fill out job application forms using this data ${DUMMY_APPLICANT_CONTEXT}.`;

// You are an intelligent AI assistant helping to fill out job application forms accurately and professionally.
...
// const fillDescriptionPrompt = `;

//               You need to fill a form field. Here's what you should do:

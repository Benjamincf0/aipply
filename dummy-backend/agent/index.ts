...
let BROWSERCASH_PROJECT_ID: string;
let BROWSERCASH_API_KEY: string;
let GOOGLE_GENERATIVE_AI_API_KEY: string;
try {
  BROWSERCASH_PROJECT_ID = process.env.BROWSERCASH_PROJECT_ID!;
  BROWSERCASH_API_KEY = process.env.BROWSERCASH_API_KEY!;
  GOOGLE_GENERATIVE_AI_API_KEY = process.env.GOOGLE_GENERATIVE_AI_API_KEY!;
} catch (e) {
  throw new Error(
    "BROWSERCASH_PROJECT_ID and BROWSERCASH_API_KEY must be set in environment variables to run this example. Please check your .env file.",
  );
}
